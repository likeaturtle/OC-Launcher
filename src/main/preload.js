...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  checkOpenCodeUpdate: () => ipcRenderer.invoke('check-opencode-update'),
  ...
  installSkillFromList: (repoPath, skillName, isGlobal, installDir) => ipcRenderer.invoke('install-skill-from-list', repoPath, skillName, isGlobal, installDir),
  ...
  analyzeSkills: (repoPath) => ipcRenderer.invoke('analyze-skills', repoPath),
